...
awful.key({modkey}, "d", function ()
    ...
    awful.key({        },   "F8",      function () awful.spawn("/home/ayslan/.config/Scripts/weather") end,
              {descrition = "exec weather", group = "Personal launchers"}),
    awful.key({"Shift",        },   "x",      function () awful.spawn("/home/ayslan/.config/Scripts/power-menu.sh") end,
